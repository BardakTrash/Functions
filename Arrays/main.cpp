...
void Print(float arr[ROWS][COLS], const int ROLS,const int COLS);
void Print(double arr[ROWS][COLS], const int ROLS,const int COLS);
void Print(char arr[ROWS][COLS], const int ROLS,const int COLS);
